    ...
    return (
        <Card>
            <View style={styles.row}>
                ...
                <TransactionInfo id={transaction.id} description={transaction.description} date={transaction.date} />
            </View>
        </Card>
    )
}

function Amount({iconName, color, amount}: {iconName: "minuscircle" | "pluscircle"; color: "red" | "green"; amount: number}) {
    return (
        <View style={styles.row}>
